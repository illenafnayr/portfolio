    ...
    <div id="navbar">
        <div @mouseleave="hideMenu">
            <StartMenu v-bind:style='{ "display": (isActive ? "FLEX" : "none") }'
                @activate-screensaver="emitScreenSaver" />
        </div>
        <div id="btnContainer">
            <div id="startbtn" v-on:click="showMenu()"
                v-bind:style='{ "border-color": (isActive ? "#808080 #FFFFFF #FFFFFF #808080" : "#FFFFFF #808080 #808080 #FFFFFF") }'>
                <img src="/images/windows.png" alt="windows" id="windowslogo">
                <span>START</span>
            </div>
        </div>
